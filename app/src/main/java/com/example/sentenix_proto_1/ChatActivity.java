                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        if (location != null) {
                            ...
                            Toast.makeText(ChatActivity.this, "Unable to retrieve location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
...
//                double distanceToKiitsquare = calculateDistance(userLat, userLong,KHANDAGIRI_LAT, KHANDAGIRI_LONG);
                ...
                if (distanceToKhandagiri < distanceToKiitsquare) {
                    ...
                    Toast.makeText(ChatActivity.this, "Message sent to Khandagiri", Toast.LENGTH_SHORT).show();
                } else {
                    database = mKiitsquareDatabase;
                    Toast.makeText(ChatActivity.this, "Message sent to Kiitsquare", Toast.LENGTH_SHORT).show();
                }
