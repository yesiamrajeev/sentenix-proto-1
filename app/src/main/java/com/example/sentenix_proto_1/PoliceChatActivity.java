...
public class PoliceChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_police);
        ...
        Button sendButton = findViewById(R.id.send_button_police);
    ...
    public void onBackPressed() {
        startActivity(new Intent(PoliceChatActivity.this, PoliceMain.class));
        finish();
        super.onBackPressed();
    }
                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        if (location != null) {
                            ...
                            Toast.makeText(PoliceChatActivity.this, "Unable to retrieve location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
...
//                double distanceToKiitsquare = calculateDistance(userLat, userLong,KHANDAGIRI_LAT, KHANDAGIRI_LONG);
                ...
                if (distanceToKhandagiri < distanceToKiitsquare) {
                    ...
                    Toast.makeText(PoliceChatActivity.this, "Message sent to Khandagiri", Toast.LENGTH_SHORT).show();
                } else {
                    database = mKiitsquareDatabase;
                    Toast.makeText(PoliceChatActivity.this, "Message sent to Kiitsquare", Toast.LENGTH_SHORT).show();
                }
...
//                                double distanceToKiitsquare = calculateDistance(userLat, userLong,KHANDAGIRI_LAT, KHANDAGIRI_LONG);
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(mContext).inflate(R.layout.list_item_police, parent, false);
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            public MyViewHolder(@NonNull View itemView) {
                super(itemView);
                itemText = itemView.findViewById(R.id.item_text_police);
            }
        }
